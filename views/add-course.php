<section class="container data-section">
    ...
    <form action="add-course" method="post">
        ...
        <input class="input is-link" id="name" type="text" name="name" placeholder="Име"
               value="<?= $_POST['name'] ?? "" ?>">
        <!--        <label for="year">Година</label>-->
        <input class="input is-link" id="year" type="number" placeholder="Година" min="1990" max="2100" name="year"
               value="<?= $_POST['year'] ?? "" ?>">
