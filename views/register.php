<div class="container">
    ...
    <form action="register" method="post" autocomplete="off">
        ...
        <input class="input is-link" id="expertise" type="text" name="expertise" placeholder="Специалност" value="<?= $_POST['expertise'] ?? null ?>"/>
        <input class="input is-link" id="pass" type="password" placeholder="Парола" name="password"/>
        <input class="input is-link" id="conf-pass" type="password" placeholder="Потвърдете паролата" name="conf_password"/>
